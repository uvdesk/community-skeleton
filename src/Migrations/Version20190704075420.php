 ...
 */
final class Version20190704075420 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(191) DEFAULT NULL, proxy_id VARCHAR(191) DEFAULT NULL, password VARCHAR(191) DEFAULT NULL, first_name VARCHAR(191) NOT NULL, last_name VARCHAR(191) DEFAULT NULL, is_enabled TINYINT(1) DEFAULT \'0\' NOT NULL, verification_code VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_E8D39F61E7927C74 (email), UNIQUE INDEX UNIQ_E8D39F61DB26A4E (proxy_id), UNIQUE INDEX UNIQ_E8D39F61E821C39F (verification_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_saved_replies (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, subject VARCHAR(255) DEFAULT NULL, message LONGTEXT NOT NULL, template_id INT DEFAULT NULL, is_predefind TINYINT(1) DEFAULT \'1\' NOT NULL, message_inline LONGTEXT DEFAULT NULL, template_for VARCHAR(255) DEFAULT NULL, INDEX IDX_39C8BA50A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_email_templates (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(191) NOT NULL, subject VARCHAR(191) NOT NULL, message LONGTEXT NOT NULL, template_type VARCHAR(255) DEFAULT NULL, is_predefined TINYINT(1) DEFAULT \'1\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_workflow (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(191) NOT NULL, description VARCHAR(255) DEFAULT NULL, conditions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', actions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', sort_order INT DEFAULT NULL, is_predefind TINYINT(1) DEFAULT \'1\' NOT NULL, status TINYINT(1) DEFAULT \'1\' NOT NULL, date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_website_knowledgebase (id INT AUTO_INCREMENT NOT NULL, website INT DEFAULT NULL, status VARCHAR(255) NOT NULL, brand_color VARCHAR(255) NOT NULL, page_background_color VARCHAR(255) NOT NULL, header_background_color VARCHAR(255) DEFAULT NULL, banner_background_color VARCHAR(255) DEFAULT NULL, link_color VARCHAR(255) DEFAULT NULL, link_hover_color VARCHAR(255) DEFAULT NULL, header_links LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', footer_links LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', article_text_color VARCHAR(255) DEFAULT NULL, white_list LONGTEXT DEFAULT NULL, black_list LONGTEXT DEFAULT NULL, site_descritption VARCHAR(1000) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, homepage_content VARCHAR(255) DEFAULT NULL, ticket_create_option VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, broadcast_message VARCHAR(255) DEFAULT NULL, remove_customer_login_button INT DEFAULT 0, disable_customer_login INT DEFAULT 0, remove_branding_content INT DEFAULT 0, login_required_to_create TINYINT(1) DEFAULT NULL, script LONGTEXT DEFAULT NULL, custom_css LONGTEXT DEFAULT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_DFF10F0B476F5DE7 (website), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_solution_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(100) DEFAULT NULL, sort_order INT DEFAULT 1, sorting VARCHAR(255) DEFAULT \'ascending\', status INT DEFAULT 0, date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE uv_article (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, keywords VARCHAR(255) DEFAULT NULL, meta_title VARCHAR(255) DEFAULT NULL, status INT DEFAULT 0, viewed INT DEFAULT NULL, stared INT DEFAULT NULL, date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, INDEX search_idx (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE uv_prepared_response_support_teams ADD CONSTRAINT FK_B6897DEBF5C464CE FOREIGN KEY (subgroup_id) REFERENCES uv_support_group (id) ON DELETE CASCADE');
